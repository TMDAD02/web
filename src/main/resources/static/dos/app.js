...
function connect() {
    //document.cookie = 'Authorization=Bearer null';
    var username = $("#chatUsername").val();
    //var socket = new SockJS('/ws');
   // req.setRequestHeader('Authorization','Bearer ' + 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJwcnVlYmEiLCJleHAiOjE2NDU1OTA4NjMsImlhdCI6MTY0NTU3Mjg2M30.lSxcdcYC7_q0oAoxV-3soYQIdJHgNnJ6T1xaHgP13uDY6jxz8IKRjFw3nig8-RQ6-SoHl_2S5iH8xGCsWtA5oA');
...
function sendName() {
    ...
    var jsonString =  JSON.stringify({'message': message, 'from': 'mario', 'to': 'maria'});
    stompClient.send("/app/chat/mario", 'maria', jsonString);
}
